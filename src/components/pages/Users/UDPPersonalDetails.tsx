  ...
  return (
    <div className="udp-personal-details">
      ...
      <div className="category-section">
        <h4 className="category-title">Identity</h4>
      ...
      {/* Contact Section */}
      <div className="category-section">
        <h4 className="category-title">Contact</h4>
        <div className="details-grid">
          <div className="detail-item">
      ...
      <div className="category-section">
        <h4 className="category-title">Personal Info</h4>
        <div className="details-grid">
          <div className="detail-item">
      ...
      <div className="category-section">
        <h4 className="category-title">Account Details</h4>
        <div className="details-grid">
          <div className="detail-item">
          ...
          <div className="detail-item">
            <VpnKeyIcon className="detail-icon" />
            <div className="detail-content">

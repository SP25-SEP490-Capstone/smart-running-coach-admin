...
import UserDetailRiskAnalysis from "./UsersRiskAnalysis/UserDetailRiskAnalysis";
...
import UDPRiskAnalysis from "./UDPRiskAnalysis";
    ...
    <div className="users-detail-page">
      ...
      <div className="rows">
        <div className="row">
          ...
          />
          <UDPRiskAnalysis loading={loading} onViewRecord={handleViewRecord} />
          <UDPRecordsSection
            loading={loading}
      ...
      {user && (
        <>
          ...
          {userRecordDialog.open &&
            userRecordDialog.record === "Risk Analysis" && (
              <CommonDialog
                title="Risk Analysis Records"
                maxWidth="lg"
                open={userRecordDialog.open}
                onClose={handleCloseRecordDialog}
                footer={
              ...
              >
                <UserDetailRiskAnalysis userId={user.id} />
              </CommonDialog>
            )}
          {suspendDialog && (
            <UDESuspendDialog
